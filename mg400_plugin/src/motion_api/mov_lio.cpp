...
#include "mg400_plugin/motion_api/mov_lio.hpp"

namespace mg400_plugin
{

void MovLIO::configure(
  ...
  const mg400_interface::MG400Interface::SharedPtr mg400_if)
{
  ...
  this->action_server_ =
    ...
    "mov_lio",
    std::bind(&MovLIO::handle_goal, this, _1, _2),
    std::bind(&MovLIO::handle_cancel, this, _1),
    std::bind(&MovLIO::handle_accepted, this, _1),
  ...
  const rclcpp_action::GoalUUID &, ActionT::Goal::ConstSharedPtr goal)
{
  ...
  if (plugin_utils::rejectMotionCommandDuringServoMode(
      this->mg400_interface_, this->node_logging_if_->get_logger(), "MovLIO"))
  {
    return rclcpp_action::GoalResponse::REJECT;
  }
