...
#ifndef __MG400_PLUGIN_DASHBOARD_API_ROBOT_MODE_HPP__
#define __MG400_PLUGIN_DASHBOARD_API_ROBOT_MODE_HPP__
...
{
class RobotMode final : public mg400_plugin_base::DashboardApiPluginBase
{
public:
  using ServiceT = mg400_msgs::srv::RobotMode;
