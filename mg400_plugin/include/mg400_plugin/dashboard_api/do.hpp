...
#ifndef __MG400_PLUGIN_DASHBOARD_API_DO_HPP__
#define __MG400_PLUGIN_DASHBOARD_API_DO_HPP__
...
{
class DO final : public mg400_plugin_base::DashboardApiPluginBase
{
public:
  using ServiceT = mg400_msgs::srv::DO;
