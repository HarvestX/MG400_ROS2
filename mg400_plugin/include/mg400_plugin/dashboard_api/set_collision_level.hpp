...
#ifndef __MG400_PLUGIN_DASHBOARD_API_SET_COLLISION_LEVEL_HPP__
#define __MG400_PLUGIN_DASHBOARD_API_SET_COLLISION_LEVEL_HPP__
...
{
class SetCollisionLevel final : public mg400_plugin_base::DashboardApiPluginBase
{
public:
  using ServiceT = mg400_msgs::srv::SetCollisionLevel;
