...
#ifndef __MG400_PLUGIN_DASHBOARD_API_GET_ANGLE_HPP__
#define __MG400_PLUGIN_DASHBOARD_API_GET_ANGLE_HPP__

#include <mg400_plugin_base/api_plugin_base.hpp>
#include <mg400_msgs/srv/get_angle.hpp>

namespace mg400_plugin
{
class GetAngle final : public mg400_plugin_base::DashboardApiPluginBase
{
public:
  using ServiceT = mg400_msgs::srv::GetAngle;
