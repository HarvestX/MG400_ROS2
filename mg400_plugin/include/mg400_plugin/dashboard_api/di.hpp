...
#ifndef __MG400_PLUGIN_DASHBOARD_API_DI_HPP__
#define __MG400_PLUGIN_DASHBOARD_API_DI_HPP__

#include <mg400_plugin_base/api_plugin_base.hpp>
#include <mg400_msgs/srv/di.hpp>

namespace mg400_plugin
{
class DI final : public mg400_plugin_base::DashboardApiPluginBase
{
public:
  using ServiceT = mg400_msgs::srv::DI;
