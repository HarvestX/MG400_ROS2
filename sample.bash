...
ros2 action send_goal /mg400/mov_j mg400_msgs/action/MovJ \
  "{pose: {header: {frame_id: mg400_origin_link, stamp: {sec: 0, nanosec: 0}}, pose: {x: 0.34, y: 0.0, z: 0.0, r: 0.0}}}"
ros2 action send_goal /mg400/mov_j mg400_msgs/action/MovJ \
  "{pose: {header: {frame_id: mg400_origin_link, stamp: {sec: 0, nanosec: 0}}, pose: {x: 0.0, y: -0.34, z: 0.0, r: 1.57}}}"
ros2 action send_goal /mg400/mov_j mg400_msgs/action/MovJ \
  "{pose: {header: {frame_id: mg400_origin_link, stamp: {sec: 0, nanosec: 0}}, pose: {x: 0.34, y: 0.0, z: 0.0, r: 0.0}}}"
