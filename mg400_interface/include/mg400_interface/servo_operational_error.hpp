...
enum class ServoOperationalErrorCode : std::uint8_t
{
  ...
  MOTION_RESPONSE_CONTROLLER_ERROR =
    mg400_msgs::msg::ServoError::OPERATIONAL_MOTION_RESPONSE_CONTROLLER_ERROR,
  MOTION_RESPONSE_TIMEOUT =
    mg400_msgs::msg::ServoError::OPERATIONAL_MOTION_RESPONSE_TIMEOUT,
  MOTION_RESPONSE_DISCONNECTED =
    mg400_msgs::msg::ServoError::OPERATIONAL_MOTION_RESPONSE_DISCONNECTED,
  MOTION_RESPONSE_PARSE_ERROR =
    mg400_msgs::msg::ServoError::OPERATIONAL_MOTION_RESPONSE_PARSE_ERROR,
  MOTION_RESPONSE_QUEUE_OVERFLOW =
    mg400_msgs::msg::ServoError::OPERATIONAL_MOTION_RESPONSE_QUEUE_OVERFLOW,
