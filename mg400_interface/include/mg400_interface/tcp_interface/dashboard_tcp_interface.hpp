...
#ifndef __MG400_INTERFACE_TCP_INTERFACE_DASHBOARD_TCP_INTERFACE_HPP__
#define __MG400_INTERFACE_TCP_INTERFACE_DASHBOARD_TCP_INTERFACE_HPP__
...
public:
  ...
  virtual bool sendCommand(const std::string &) = 0;
...
public:
  ...
  bool isConnected();
  bool sendCommand(const std::string &) override;
  std::string recvResponse(void) override;
  void disConnect();

private:
  void checkConnection();
  bool isValidMessageFormat(const std::string & cmd) const;
};
}  // namespace mg400_interface
#endif
